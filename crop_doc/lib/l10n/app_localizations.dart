...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'MaizeDoc is an AI-driven mobile app providing digital extension services for maize farmers. The app uses a ConvDeit-tiny vision transformer to classify maize leaf diseases from uploaded images, reducing human error in diagnosis.It provides locally available treatment recommendations and uses Explainable AI (LIME) heatmaps to show which image regions informed the classification, promoting user trust and transparency in the AI\'s decision. This complements and assists manual efforts by traditional extension officers.'**
  ...
  /// No description provided for @countyLabel.
  ///
  /// In en, this message translates to:
  /// **'County'**
  String get countyLabel;
  ...
  ///
  /// In en, this message translates to:
  /// **'Please complete the form and give consent'**
  ...
  /// No description provided for @extensionOfficer.
  ///
  /// In en, this message translates to:
  /// **'Extension Officer'**
  String get extensionOfficer;
  ...
  /// No description provided for @sampleImages.
  ///
  /// In en, this message translates to:
  /// **'Sample Images'**
  String get sampleImages;
}
